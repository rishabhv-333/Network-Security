...
//SOURCE:https://www.scaler.com/topics/des-algorithm/
...
void print_enc(string combined_text, int i)
{
    string ciphertext = "";
    ...
    for (int i = 0; i < 64; i++)
    {
        if (ciphertext[i] != pt[i]) HD++;
    }
    // cout << "Hamming Distance of Round:" << i + 1 << endl << HD << endl;
    cout << HD << endl;
    // cout << "Round " << i + 1 << endl << ciphertext << endl;
}
...
int main() {
    ...
    pt =  "1010101111011101111001101110101111001101000100100010010110110110";
